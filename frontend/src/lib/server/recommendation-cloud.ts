  ...
  const suggestions = settledBuilders.flatMap((result, index) => {
    ...
    return result.value.suggestions
      ...
      .map((suggestion) => ({
        ...
        odds_source: suggestion.odds_source,
        bookmaker_source_label: suggestion.bookmaker_source_label,
        bookmaker_display: suggestion.bookmaker_display,
        is_french_bookmaker: suggestion.is_french_bookmaker,
...
export async function getDailyRecommendations(input: RecommendationInput = {}) {
  ...
  return {
    ...
    singles: singles.map((candidate) => ({
      ...
      bookmaker_source_label: candidate.bookmaker_source_label,
      is_french_bookmaker: candidate.is_french_bookmaker,
      ...
      ? [
          {
            ...
            legs: parlay.legs.map((leg) => ({
              ...
              bookmaker_source_label: leg.bookmaker_source_label,
              is_french_bookmaker: leg.is_french_bookmaker,
